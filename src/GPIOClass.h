...
public:
	GPIOClass::GPIOClass();
	GPIOClass::GPIOClass(string x); // create a GPIO object that controls GPIOx, where x is passed to this constructor
    int GPIOClass::export_gpio(); // exports GPIO
    int GPIOClass::unexport_gpio(); // unexport GPIO
